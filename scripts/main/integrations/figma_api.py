...
os.environ["OPENROUTER_API_KEY"] = os.getenv('OPENROUTER_API_KEY', "***REDACTED_OPENROUTER_KEY***") # Replace with your actual API key
...
try:
    ...
    cl = Client()
    cl.login("cryptoprism.io", "***REDACTED_DB_PASSWORD***")
